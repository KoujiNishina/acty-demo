...
namespace IoTHubJavaClientRewrittenInDotNet
{
    public class Message
    {
        ...
        public static Encoding DEFAULT_IOTHUB_MESSAGE_CHARSET = Encoding.UTF8;
    ...
    private String messageId;
        ...
        public Message(String body)
        {
            ...
            this.body = DEFAULT_IOTHUB_MESSAGE_CHARSET.GetBytes(body);
        }
        ...
        public byte[] getBytes()
        {
            ...
            if (this.body != null)
            {
                bodyClone = new byte[this.body.Length];
                Array.Copy(this.body, bodyClone, this.body.Length);
        ...
        public String getProperty(String name)
        {
            ...
            foreach (MessageProperty currentMessageProperty in this.properties)
            {
            ...
            {
                throw new ArgumentException("Message does not contain a property with name '" + name + "'.");
            }
        ...
        private void initialize()
        {
            ...
            this.lockToken = Guid.NewGuid().ToString();
        ...
        private String generateId(int length)
        {
            ...
            {
                charSequence[i] = validCharacters[random.Next(validCharacters.Length)];
            }
        ...
        public bool isExpired()
        {
            ...
            else
            {
                ...
                long currentTime = DateTimeUtils.GetCurrentTimeMillis();//System.currentTimeMillis();
